...
- Create Angular project with ng: `ng new chtfkbibliotek.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`chtfkbibliotek.client.esproj`).
